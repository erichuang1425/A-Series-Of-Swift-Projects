...
struct StoryBrain {
    ...
    func currentStoryTitle()->String{
        return library[storyNumber].title
    }
    func currentStoryChoice1()->String{
        return library[storyNumber].choice1
    }
    func currentStoryChoice2()->String{
        return library[storyNumber].choice2
    }
    mutating func nextStorychoice1Title(){
        storyNumber = library[storyNumber].choice1destination
    }
    mutating func nextStorychoice2Title(){
        storyNumber = library[storyNumber].choice2destination
    }
